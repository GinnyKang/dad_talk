...
<style>
#info h3 {color: #009999; margin-top:0px;}
...
<div class="modal fade" id="login-modal" tabindex="-1" role="dialog"
	...
	<div class="row">
		<div class="col-md-3 col-lg-3 hidden-xs hidden-sm" id="sidemenu">
			...
			<h4>육아정보</h4>
            <li class="active">
            <a href="/dad_talk/babyinfo/info.do?act=ob">임신 <span class="sr-only">(current)</span></a></li>
            <li><a href="/dad_talk/babyinfo/info.do?act=cb">출산</a></li>
            <li><a href="/dad_talk/babyinfo/info.do?act=if">육아&놀이법</a></li>
            <li><a href="/dad_talk/babyinfo/info.do?act=play">0~12개월 월령별 놀이</a></li>
            <li><a href="/dad_talk/babyinfo/info.do?act=pl">육아휴직</a></li>
		...
		<div class="col-md-9 col-lg-9" id="info">
			<h3><img src="/dad_talk/resources/images/pl.png">  육아휴직</h3>
			<br>
			<button type="button" class="btn btn-info" id="pl_1">아빠 육아휴직이 필요한 이유</button>
			<button type="button" class="btn btn-info" id="pl_2">준비 방법</button>
			<button type="button" class="btn btn-info" id="pl_3">신청 방법</button>
		    <br><br><hr><br>
...
$(document).ready(function(){
    $("#response").load("/dad_talk/resources/text/pl_1.txt");
    $("#pl_1").click(function(){
        $("#response").load("/dad_talk/resources/text/pl_1.txt");
    });
    $("#pl_2").click(function(){
            $("#response").load("/dad_talk/resources/text/pl_2.txt");
        });
    $("#pl_3").click(function(){
            $("#response").load("/dad_talk/resources/text/pl_3.txt");
        });
