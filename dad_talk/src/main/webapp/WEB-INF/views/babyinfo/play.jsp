...
#info button{width:20%; height:40px; margin: 5px 10px; }
...
<div class="modal fade" id="login-modal" tabindex="-1" role="dialog"
	...
	<div class="row">
		...
		<div class="col-md-9 col-lg-9" id="info">
			<h3><img src="/dad_talk/resources/images/play.png">  0~12개월 월령별 놀이</h3>
			<br>
			    <button type="button" class="btn btn-info" id="play_1">0~1개월</button>
			    <button type="button" class="btn btn-info" id="play_2">2개월</button>
			    <button type="button" class="btn btn-info" id="play_3">3개월</button>
			    <button type="button" class="btn btn-info" id="play_4">4개월</button>
				<button type="button" class="btn btn-info" id="play_5">5개월</button>
			    <button type="button" class="btn btn-info" id="play_6">6개월</button>
			    <button type="button" class="btn btn-info" id="play_7">7개월</button>
			    <button type="button" class="btn btn-info" id="play_8">8개월</button>
			    <button type="button" class="btn btn-info" id="play_9">9개월</button>
			    <button type="button" class="btn btn-info" id="play_10">10개월</button>
			    <button type="button" class="btn btn-info" id="play_11">11개월</button>
			    <button type="button" class="btn btn-info" id="play_12">12개월</button>
		    <br><br><hr><br>
...
$(document).ready(function(){
    ...
    $("#response").load("/dad_talk/resources/text/play_1.txt");
    $("#play_1").click(function(){
        $("#response").load("/dad_talk/resources/text/play_1.txt");
    });
    $("#play_2").click(function(){
            $("#response").load("/dad_talk/resources/text/play_2.txt");
        });
    $("#play_3").click(function(){
            $("#response").load("/dad_talk/resources/text/play_3.txt");
        });
    $("#play_4").click(function(){
        $("#response").load("/dad_talk/resources/text/play_4.txt");
    });
    $("#play_5").click(function(){
        $("#response").load("/dad_talk/resources/text/play_5.txt");
    });
    $("#play_6").click(function(){
        $("#response").load("/dad_talk/resources/text/play_6.txt");
    });
    $("#play_7").click(function(){
        $("#response").load("/dad_talk/resources/text/play_7.txt");
    });
    $("#play_8").click(function(){
        $("#response").load("/dad_talk/resources/text/play_8.txt");
    });
    $("#play_9").click(function(){
        $("#response").load("/dad_talk/resources/text/play_9.txt");
    });
    $("#play_10").click(function(){
        $("#response").load("/dad_talk/resources/text/play_10.txt");
    });
    $("#play_11").click(function(){
        $("#response").load("/dad_talk/resources/text/play_11.txt");
    });
    $("#play_12").click(function(){
        $("#response").load("/dad_talk/resources/text/play_12.txt");
    });
