...
<style>
#info h3 {color:#ff4d4d; margin-top:0px;}
...
<div class="modal fade" id="login-modal" tabindex="-1" role="dialog"
	...
	<div class="row">
		...
		<div class="col-md-9 col-lg-9" id="info">
			<h3><img src="/dad_talk/resources/images/pgn.png">  임신</h3>
			<br>
			<button type="button" class="btn btn-info" id="pgn_1">출산준비</button>
			<button type="button" class="btn btn-info" id="pgn_2">아빠의 태교</button>
		    <button type="button" class="btn btn-info" id="pgn_3">출산 전 남편이 준비할 일</button>
			<button type="button" class="btn btn-info" id="pgn_4">집에서 아내의 진통이 시작되었을 때</button>
			<br><br><hr><br>
...
$(document).ready(function(){
    $("#response").load("/dad_talk/resources/text/pgn_1.txt");
    $("#pgn_1").click(function(){
        $("#response").load("/dad_talk/resources/text/pgn_1.txt");
    });
    $("#pgn_2").click(function(){
            $("#response").load("/dad_talk/resources/text/pgn_2.txt");
        });
    $("#pgn_3").click(function(){
            $("#response").load("/dad_talk/resources/text/pgn_3.txt");
        });
    $("#pgn_4").click(function(){
            $("#response").load("/dad_talk/resources/text/pgn_4.txt");
        });
});
