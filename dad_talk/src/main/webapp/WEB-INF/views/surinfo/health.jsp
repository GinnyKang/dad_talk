...
<style>
#info h3 {color: #00cc44; margin-top:0px; margin-left:10px;}
...
<script>
	$(document).ready(function() {
		...
		$("#map").html("<img src='/dad_talk/resources/images/keum_3.png'>");
		$("#keum").click(function() {
		      $("#map").html("<img src='/dad_talk/resources/images/keum_3.png'>");
		});
		$("#jak").click(function() {
		      $("#map").html("<img src='/dad_talk/resources/images/jak_3.png'>");
		});	
		$("#man").click(function() {
		      $("#map").html("<img src='/dad_talk/resources/images/man_3.png'>");
		});	
		$("#dong").click(function() {
		      $("#map").html("<img src='/dad_talk/resources/images/dong_3.png'>");
		});	
		$("#kwang").click(function() {
		      $("#map").html("<img src='/dad_talk/resources/images/kwang_3.png'>");
		});
	});
</script>
</body>
