...
<style>
#info h3 {color: #ff4d4d; margin-top:0px; margin-left:10px;}
...
<script>
	$(document).ready(function() {
		...
		$("#map").html("<img src='/dad_talk/resources/images/keum.png'>");
		$("#keum").click(function() {
		      $("#map").html("<img src='/dad_talk/resources/images/keum.png'>");
		});
		$("#jak").click(function() {
		      $("#map").html("<img src='/dad_talk/resources/images/jak.png'>");
		});	
		$("#man").click(function() {
		      $("#map").html("<img src='/dad_talk/resources/images/man.png'>");
		});	
		$("#dong").click(function() {
		      $("#map").html("<img src='/dad_talk/resources/images/dong.png'>");
		});	
		$("#kwang").click(function() {
		      $("#map").html("<img src='/dad_talk/resources/images/kwang.png'>");
		});
	});
</script>
</body>
