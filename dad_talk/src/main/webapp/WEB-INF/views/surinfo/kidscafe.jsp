...
<style>
#info h3 {color: #bf40bf; margin-top:0px; margin-left:10px;}
...
<script>
	$(document).ready(function() {
		...
		$("#map").html("<img src='/dad_talk/resources/images/keum_2.png'>");
		$("#keum").click(function() {
		      $("#map").html("<img src='/dad_talk/resources/images/keum_2.png'>");
		});
		$("#jak").click(function() {
		      $("#map").html("<img src='/dad_talk/resources/images/jak_2.png'>");
		});	
		$("#man").click(function() {
		      $("#map").html("<img src='/dad_talk/resources/images/man_2.png'>");
		});	
		$("#dong").click(function() {
		      $("#map").html("<img src='/dad_talk/resources/images/dong_2.png'>");
		});	
		$("#kwang").click(function() {
		      $("#map").html("<img src='/dad_talk/resources/images/kwang_2.png'>");
		});
	});
</script>
</body>
